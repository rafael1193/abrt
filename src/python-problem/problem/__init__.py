...
class Problem(object):
    ...
    @property
    def non_reportable(self):
        return hasattr(self, 'not-reportable')

    @non_reportable.setter
    def non_reportable(self, value):
    ...
    @property
    def non_reportable_reason(self):
        if hasattr(self, 'not-reportable'):
            return getattr(self, 'not-reportable')

        return None

    @non_reportable_reason.setter
    def non_reportable_reason(self, value):
        setattr(self, 'not-reportable', value)
